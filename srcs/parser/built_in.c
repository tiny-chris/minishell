...
/*   Updated: 2022/10/12 02:08:05 by cgaillag         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	**ft_built_in(void)
{
	...
	built_in = ft_handle_malloc(MALLOC_M, NULL, TAB_STR2, (7 + 1));
	...
	ft_handle_malloc(ADD_M, built_in[0], TAB_STR1, 0);
	printf("built in[0] char * addr = %p\n", built_in[0]);
	built_in[1] = ft_strdup("cd");
	ft_handle_malloc(ADD_M, built_in[1], TAB_STR1, 0);
	built_in[2] = ft_strdup("pwd");
	ft_handle_malloc(ADD_M, built_in[2], TAB_STR1, 0);
	built_in[3] = ft_strdup("export");
	// // TEST5
	// free(built_in[3]);
	// built_in[3] = NULL;///
	ft_handle_malloc(ADD_M, built_in[3], TAB_STR1, 0);
	built_in[4] = ft_strdup("unset");
	ft_handle_malloc(ADD_M, built_in[4], TAB_STR1, 0);
	built_in[5] = ft_strdup("env");
	ft_handle_malloc(ADD_M, built_in[5], TAB_STR1, 0);
	built_in[6] = ft_strdup("exit");
	ft_handle_malloc(ADD_M, built_in[6], TAB_STR1, 0);
	built_in[7] = NULL;
